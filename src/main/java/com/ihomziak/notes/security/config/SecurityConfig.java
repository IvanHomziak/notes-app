...
import com.ihomziak.notes.security.jwt.AuthEntryPointJwt;
import com.ihomziak.notes.security.jwt.AuthTokenFilter;
...
public class SecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.cors(withDefaults());// CORS configuration
